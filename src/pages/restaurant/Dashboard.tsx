              ...
              {[1, 2, 3, 4].map((order) => (
                <div key={order} className="flex items-center justify-between border-b pb-2">
                  <div className="min-w-0 flex-1 pr-4">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">Γé╣{Math.floor(Math.random() * 1000)}</p>
                  </div>
              ...
              {['Paneer Butter Masala', 'Dal Makhani', 'Veg Biryani', 'Chole Bhature'].map((dish, index) => (
                <div key={index} className="flex items-center justify-between border-b pb-2">
                  <div className="min-w-0 flex-1 pr-4">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">Γé╣{150 + (index * 25)}</p>
                  </div>
                  <div className="text-right flex-shrink-0">
